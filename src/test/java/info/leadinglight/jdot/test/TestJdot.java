...
/**
 * Test JDOT by generating the SVG graphs for the samples and comparing it
 * to the SVG generated for the sample DOT files included in Graphviz.
 */
public class TestJdot {
