...
public class Alf {
    ...
    public static Graph g() {
        ...
        g.addNodes(
                // Note: When specifying labels with CRs in them, be sure to use the 
                // Java syntax for escaping the leading \. It is the responsibility
                // of the client to manage this.
                new Node("Decl")
